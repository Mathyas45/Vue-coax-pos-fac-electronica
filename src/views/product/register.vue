                    ...
                    <b-card-body class="pt-0">
                        ...
                        <b-row>
                            ...
                            <b-col lg="1" md="1">
                                ...
                                <b-form-radio name="include_igv" @click="include_igv = 0" value="0" :checked="include_igv == 0">No</b-form-radio>
                                <b-form-radio name="include_igv" @click="include_igv = 1" value="1" :checked="include_igv == 1">Si</b-form-radio>
                            </b-col>
                            <b-col lg="2" md="2">
...
const IMAGEN_PREVIZUALIZA = ref<string>('');
